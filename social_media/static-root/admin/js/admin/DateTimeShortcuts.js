...
'use strict';
{
    const DateTimeShortcuts = {
        ...
        dismissClockFunc: [],
        dismissCalendarFunc: [],
        calendarDivName1: 'calendarbox', // name of calendar <dev> that gets toggled
        calendarDivName2: 'calendarin', // name of <dev> that contains calendar
        calendarLinkName: 'calendarlink', // name of the link that is used to toggle
        clockDivName: 'clockbox', // name of clock <dev> that gets toggled
        ...
        addClock: function(inp) {
            ...
            // Create clock link dev
            //
            // Markup looks like:
            // <dev id="clockbox1" class="clockbox module">
            //     <h2>Choose a time</h2>
            //     <ul class="timelist">
            //         <li><a href="#">Now</a></li>
        ...
        addCalendar: function(inp) {
            ...
            // Create calendarbox dev.
            //
            // Markup looks like:
            //
            // <dev id="calendarbox3" class="calendarbox module">
            //     <h2>
            //           <a href="#" class="link-previous">&lsaquo;</a>
            //           <a href="#" class="link-next">&rsaquo;</a> February 2003
            //     </h2>
            //     <dev class="calendar" id="calendarin3">
            //         <!-- (cal) -->
            //     </dev>
            //     <dev class="calendar-shortcuts">
