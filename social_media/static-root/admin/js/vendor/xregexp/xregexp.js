...
module.exports = function(XRegExp) {
     ...
     * str = 'Here is <dev> <dev>an</dev></dev> example';
     * XRegExp.matchRecursive(str, '<dev\\s*>', '</dev>', 'gi', {
     *   valueNames: ['between', 'left', 'match', 'right']
     * });
     * // -> [
     * // {name: 'between', value: 'Here is ',       start: 0,  end: 8},
     * // {name: 'left',    value: '<dev>',          start: 8,  end: 13},
     * // {name: 'match',   value: ' <dev>an</dev>', start: 13, end: 27},
     * // {name: 'right',   value: '</dev>',         start: 27, end: 33},
