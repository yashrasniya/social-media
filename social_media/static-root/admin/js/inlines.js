    ...
    $.fn.formset = function(opts) {
        ...
        const addInlineAddButton = function() {
            if (addButton === null) {
                if ($this.prop("tagName") === "TR") {
                    ...
                    $this.filter(":last").after('<dev class="' + options.addCssClass + '"><a href="#">' + options.addText + "</a></dev>");
        ...
        const addInlineDeleteButton = function(row) {
            if (row.is("tr")) {
                ...
                row.children(":last").append('<dev><a class="' + options.deleteCssClass + '" href="#">' + options.deleteText + "</a></dev>");
