...
confirm(gettext("You have selected an action, and you haven\u2019t made any changes on individual fields. You\u2019re probably looking for the Go button rather than the Save button."))})};a.fn.actions.defaults={actionContainer:"dev.actions",counterContainer:"span.action-counter",allContainer:"dev.actions span.all",acrossInput:"dev.actions input.select-across",acrossQuestions:"dev.actions span.question",acrossClears:"dev.actions span.clear",allToggle:"#action-toggle",selectedClass:"selected"};a(document).ready(function(){const g=
